...
export function UrlShortenerVideoDemo() {
  ...
  return (
    <div className="relative mx-auto w-full max-w-[465px] sm:max-w-[475px]">
      ...
      <div className="relative overflow-hidden rounded-3xl border border-slate-200/90 bg-white shadow-2xl shadow-slate-950/5 transition-all">
        ...
        <div className="relative p-4 sm:p-5 min-h-[400px] flex flex-col justify-between select-none">
          {/* Inner Content scaled down by 5% */}
          <div className="w-full flex-1 flex flex-col justify-between transform scale-[0.95] origin-center">
            ...
            <div className="space-y-3.5 sm:space-y-4">
              ...
              <div className="flex items-center gap-3">
                <div className="flex size-9.5 items-center justify-center rounded-2xl bg-blue-600 text-white shadow-md shadow-blue-500/20">
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`relative flex-1 flex items-center h-10.5 rounded-2xl border px-3.5 text-xs sm:text-sm transition-all duration-200 ${
                    inputValue
                ...
                <button
                  type="button"
                  className={`h-10.5 px-4 rounded-2xl font-bold text-xs sm:text-sm transition-all duration-200 flex items-center gap-1.5 shrink-0 select-none shadow-sm ${
                    isShortening
              ...
              <div
                className={`flex items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-slate-50/80 p-3 transition-all duration-400 ${
                  showShortUrl
              ...
              >
                ...
                <button
                  type="button"
                  className={`h-8.5 px-3.5 rounded-xl text-xs font-bold transition-all duration-150 flex items-center gap-1.5 shrink-0 shadow-xs ${
                    isCopied
              ...
              >
                {/* QR Code SVG */}
                <div className="size-15 sm:size-16 rounded-2xl border border-slate-200 bg-white p-1.5 shadow-sm flex items-center justify-center shrink-0">
                ...
                <div className="flex items-center gap-1.5 font-handwriting text-blue-600 select-none">
                  ...
                  <span className="text-base sm:text-lg font-bold -mt-1.5">
                    Share via QR Code
                  </span>
                </div>
              </div>
            ...
            <div
              className={`mt-5 grid grid-cols-3 divide-x divide-slate-100 rounded-2xl bg-slate-50/90 p-2.5 sm:p-3 border border-slate-100 text-center transition-all duration-500 ${
                showAnalytics
