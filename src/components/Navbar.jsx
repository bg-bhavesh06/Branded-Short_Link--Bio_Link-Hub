  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-200/60 bg-white/80 backdrop-blur-md transition-all">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex size-9 items-center justify-center rounded-xl bg-gradient-to-tr from-indigo-600 via-indigo-500 to-purple-500 text-white shadow-md shadow-indigo-500/20 group-hover:scale-105 transition-transform">
        ...
        <nav className="hidden md:flex items-center gap-1 lg:gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-slate-600 hover:text-slate-900 rounded-lg hover:bg-slate-50 transition-colors">
              Products
              <ChevronDown className="size-4 opacity-70 transition-transform group-data-[popup-open]:rotate-180" />
            </DropdownMenuTrigger>
            <DropdownMenuContent align="start" className="w-64 p-2 shadow-xl border-slate-200/80">
              <DropdownMenuItem
                onClick={() => handleNavigation("/links")}
                className="flex items-start gap-3 p-2.5 rounded-lg hover:bg-indigo-50/70"
              >
                <div className="p-2 rounded-md bg-indigo-100/80 text-indigo-600 mt-0.5">
                  <Link2 className="size-4" />
                </div>
                <div>
                  <div className="font-medium text-slate-900 text-sm">URL Shortener</div>
              ...
              <DropdownMenuItem
                ...
                className="flex items-start gap-3 p-2.5 rounded-lg hover:bg-purple-50/70"
              >
                <div className="p-2 rounded-md bg-purple-100/80 text-purple-600 mt-0.5">
                  <LayoutGrid className="size-4" />
                </div>
                <div>
                  <div className="font-medium text-slate-900 text-sm">Link-in-Bio</div>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Button
            ...
            variant="default"
            className="bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl shadow-sm px-4.5 font-semibold text-sm"
          >
            Get Started
          </Button>
        </div>
        ...
        <div className="md:hidden border-b border-slate-200 bg-white/95 px-4 pt-3 pb-6 shadow-lg backdrop-blur-md animate-in slide-in-from-top-2">
          <div className="flex flex-col space-y-1">
            ...
            <div>
              ...
              {mobileProductsOpen && (
                <div className="ml-4 pl-2 border-l-2 border-indigo-100 space-y-1 mt-1">
                  <button
                    type="button"
                    onClick={() => handleNavigation("/links")}
                    className="flex w-full items-center gap-2 px-3 py-2 text-sm text-slate-600 hover:text-indigo-600"
                  >
                  ...
                  <button
                    type="button"
                    onClick={() => handleNavigation("/bio-builder")}
                    className="flex w-full items-center gap-2 px-3 py-2 text-sm text-slate-600 hover:text-purple-600"
                  >
                    <LayoutGrid className="size-4 text-purple-500" />
                    Link-in-Bio
                  </button>
                </div>
              )}
            ...
            <div className="pt-4 border-t border-slate-100 flex flex-col gap-2.5">
              ...
              <Button
                onClick={() => handleNavigation("/signup")}
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white justify-center py-2.5 rounded-xl font-semibold text-sm shadow-md"
              >
                Get Started
              </Button>
            </div>
