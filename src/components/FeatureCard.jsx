...
export function FeatureCard({ icon: Icon, iconBg, iconColor, title, description }) {
  return (
    <Card className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:shadow-lg hover:shadow-indigo-500/5 hover:border-indigo-100 group">
